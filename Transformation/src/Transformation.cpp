...
//Triangulation Transformation::Transformation::rotation_x(Triangulation& triangulation, double rotate_x , double rotate_y , double rotate_z)
//{
//    std::vector<double> nmatrix{ 0.0,0.0,0.0,0.0 };
//    std::vector<Point> vertices;
//    Geometry::Matrix4x4 matrix;
...
//}
//
//Triangulation Transformation::Transformation::rotation_y(Triangulation& triangulation, Geometry::Matrix4x4& matrix, double rotate_y)
//{
//    std::vector<double> nmatrix{ 0.0,0.0,0.0,0.0 };
//    std::vector<Point> vertices;
//    matrix.setval(cos((rotate_y * PI) / 180), 0, 0);
//    matrix.setval(-sin((rotate_y * PI) / 180), 2, 0);
//    matrix.setval(sin((rotate_y * PI) / 180), 0, 2);
//    matrix.setval(cos((rotate_y * PI) / 180), 2, 2);
//    std::map<double, int, Transformation> uniqueMap;
//    Triangulation newtriangulation;
//
//    for (Triangle tri : triangulation.Triangles)
...
//}
//
//Triangulation Transformation::Transformation::rotation_z(Triangulation& triangulation, Geometry::Matrix4x4& matrix, double rotate_z)
//{
//    std::vector<double> nmatrix{ 0.0,0.0,0.0,0.0 };
//    std::vector<Point> vertices;
//    matrix.setval(cos((rotate_z * PI) / 180), 0, 0);
//    matrix.setval(-sin((rotate_z * PI) / 180), 0, 1);
//    matrix.setval(sin((rotate_z * PI) / 180), 1, 0);
//    matrix.setval(cos((rotate_z * PI) / 180), 1, 1);
//    std::map<double, int, Transformation> uniqueMap;
//    Triangulation newtriangulation;
//
//    for (Triangle tri : triangulation.Triangles)
