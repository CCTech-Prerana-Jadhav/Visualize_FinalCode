...
void Transformation::Transform::Scale(Triangulation& inputTriangulation, Triangulation& outputTriangulation, float Scalingfactor)
{
	Matrix4x4 matrix4x4;
...
void Transform::Transform::rotate()
{
}

void Transform::Transform::translate()
{
}
